...
using FakerDemonstration.Generators.Collections;
using FakerDemonstration.Generators.ScalarValues;
...
namespace FakerDemonstration
{
        ...
        public class Faker
        {
            ...
            {
                var pluginsLoader = new PluginLoader("Path to plugins");
            ...
            private object InitConstructor(IEnumerable<ConstructorInfo> constructors)
            {
                ...
                foreach (var constructor in constructors)
                {
                    ...
                    {
                        // iterating over constructors
                    }
                }

                if (obj == null) throw new Exception("Faker can't crate object of class ");
                return obj;
            }
